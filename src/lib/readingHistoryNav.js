...
export function buildReadingHistoryNavigateTarget(item) {
  ...
  if (!novelId || !isNovelListedInCatalog(novelId)) return null
  const novel = getListedNovelSummaryById(novelId)
